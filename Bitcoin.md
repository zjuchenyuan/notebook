...
function showwatch2(){localStorage.setItem("watchtab","showwatch2");return showtrs(['DOT','MKR','BTM','XRP','IOST','KSM','ZEC','bETH','bTRX','bDOT','bFIL'])}
function showwatch3(){localStorage.setItem("watchtab","showwatch3");return showtrs(['BCH','QTUM','STORJ','ONT','ETC','LTC','bETC','oCRV','oONT'])}
