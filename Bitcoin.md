...
function showwatch2(){localStorage.setItem("watchtab","showwatch2");return showtrs(['CRV','XCH','ICP','SHIB','FIL','KSM','BCH','COMP','hBNB'])}
function showwatch3(){localStorage.setItem("watchtab","showwatch3");return showtrs(['KSM','DOT','XCH','BSV','DOGE'])}
